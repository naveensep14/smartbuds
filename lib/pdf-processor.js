...
class PDFProcessor {
  ...
  async generateQuestionsForConcept(concept, subject, grade, pdfBuffer, numQuestions = 10) {
    try {
  ...
  async processPDF(pdfBuffer, subject, grade, board) {
    try {
      ...
      for (const concept of concepts) {
        ...
        const questions = await this.generateQuestionsForConcept(concept, subject, grade, pdfBuffer);
