...
export default function InProgressTests() {
  ...
  const handleDelete = async (userEmail: string, testId: string) => {
    ...
    try {
      ...
      successDiv.className = 'fixed top-4 right-4 z-50 flex items-center space-x-3 px-4 py-3 rounded-lg shadow-lg border bg-green-50 border-green-200 text-green-800';
      successDiv.innerHTML = `
        <svg class="w-5 h-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
        </svg>
        <span class="font-medium">Test progress deleted successfully!</span>
        <button onclick="this.parentElement.remove()" class="ml-2 p-1 rounded-full hover:bg-black hover:bg-opacity-10 transition-colors">
